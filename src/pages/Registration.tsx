          ...
          <FormCard>
            ...
            >
              <FormLabel htmlFor="username" sx={{ display: "flex" }}>
                ...
                <Box
                  component="span"
                  sx={{ display: !errors.username ? "none" : "block" }}
                >
                  <Close />
                </Box>
              </FormLabel>
              ...
              <FormLabel htmlFor="useremail" sx={{ display: "flex" }}>
                ...
                <Box
                  ...
                  sx={{
                    display:
                      getValues("useremail") && !errors.useremail
                        ? "block"
                        : "none",
                  }}
                >
                ...
                <Box
                  component="span"
                  sx={{ display: !errors.useremail ? "none" : "block" }}
                >
                  <Close />
                </Box>
              </FormLabel>
              ...
              <FormLabel htmlFor="password" sx={{ display: "flex" }}>
                ...
                <Box
                  component="span"
                  sx={{ display: !errors.password ? "none" : "block" }}
                >
                  <Close />
                </Box>
              </FormLabel>
              ...
              <FormLabel htmlFor="confirmPassword" sx={{ display: "flex" }}>
                ...
                <Box
                  sx={{
                    display:
                      getValues("confirmPassword") && !errors.confirmPassword
                        ? "block"
                        : "none",
                  }}
                >
                ...
                <Box
                  sx={{ display: !errors.confirmPassword ? "none" : "block" }}
                >
                  <Close />
                </Box>
              </FormLabel>
